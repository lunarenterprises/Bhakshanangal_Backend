...
module.exports.Getorder = async(condition)=>{
    var Query = `select user_name,order_product_order_id as order_id,order_product_product_id as product_id ,order_product_quantity as order_quantity,order_product_unit as order_unit,created_at,modified_at,order_status,order_payment_method,gift_card,delivery_mode_status from  bh_order_product
