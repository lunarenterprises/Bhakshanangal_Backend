...
module.exports.AddAddressQuery = async (
  full_name,
  phone_number,
  alt_phone_number,
  pincode,
  ...
  var Query = `insert into bh_address(address_fullname,address_phone_number,address_pincode,address_state,address_city,address_building_name,address_area_name,address_landmark,address_status,address_user_id${alt_ph})values(?,?,?,?,?,?,?,?,?,?${alt_phs})`;
